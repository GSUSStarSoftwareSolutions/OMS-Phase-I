...
//   String tax = item['tax'];
//   double discountRound = double.parse(discount.replaceAll('%', '')) / 100;
//   double taxRound = double.parse(tax.replaceAll('%', '')) / 100;
//   double totalAmount = price - discountRound + taxRound;
//   return item['totalAmount'] = totalAmount;
// }
...
//original code don't touch this
// double calculateTotalAmount(Map<String, dynamic> item) {
//   double actualAmount = item['actualAmount'];
//   double totalAmount = item['totalAmount'];
//
...
//   print(totalAmount);
//
//   // Check if actualAmount and totalAmount are the same
//  // if (actualAmount == totalAmount) {
//     // Perform calculation only if actualAmount and totalAmount match
//     double price = item['price']; // 8000
//     String discountStr = item['discount']; // "4%"
//     String taxStr = item['tax']; // "18%"
//     // Remove the '%' character and convert to numeric values
//     double discountConv = double.parse(discountStr.replaceAll('%', '')) / 100; // 0.12
//     double taxConv = double.parse(taxStr.replaceAll('%', '')) / 100; // 0.28
//     // Calculate discount and tax amounts
//     double discountAmount = price * discountConv;
//     double taxAmount = price * taxConv;
//
//     // Calculate total amount
//     double priceRound = double.parse(price.toStringAsFixed(2)); // 1800.00
//     double discountAmountRound = double.parse(discountAmount.toStringAsFixed(2)); // 216.00
//     double taxAmountRound = double.parse(taxAmount.toStringAsFixed(2)); // 504.00
//
//     // double calculation = priceRound - discountAmountRound;
//     //
//     // double finalvalue = calculation * taxAmountRound;
//
//     double totalAmountCalculated = (priceRound - discountAmountRound) + taxAmountRound; // 2088.00
//     double totalAmountRound = totalAmountCalculated * item['qty'];
//
//     return double.parse(totalAmountRound.toStringAsFixed(2));
//   // } else {
//   //   // If actualAmount and totalAmount do not match, return the current totalAmount
//   //   return totalAmount;
//   // }
// }
...
// double calculateTotalAmount(Map<String, dynamic> item) {
//   double price = item['price']; // 1800
//   String discountStr = item['discount']; // "12%"
//   String taxStr = item['tax']; // "28%"
//   // Remove the '%' character and convert to numeric values
//   double discountConv = double.parse(discountStr.replaceAll('%', '')) / 100; // 0.12
//   double taxConv = double.parse(taxStr.replaceAll('%', '')) / 100; // 0.28
//   // Calculate discount and tax amounts
//   double discountAmount = price * discountConv; // 216
//   double taxAmount = price * taxConv; // 504
//
//   // Calculate total amount
//   double priceRound = double.parse(price.toStringAsFixed(2)); // 1800.00
//   double discountAmountRound = double.parse(discountAmount.toStringAsFixed(2)); // 216.00
//   double taxAmountRound = double.parse(taxAmount.toStringAsFixed(2)); // 504.00
//
//   double totalAmount = (priceRound - discountAmountRound) + taxAmountRound; // 2088.00
//   double totalAmountRound1 = double.parse(totalAmount.toStringAsFixed(2)); // 2088.00
//
//   double totalAmountRound = totalAmountRound1 * item['qty'];
//
