...
class ResponsiveeditviewOrdersPage extends StatelessWidget {
  final String? orderId;
  //DashboardScreen({super.key,});
  const ResponsiveeditviewOrdersPage({super.key,this.orderId});
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    context.go('/Order_List'); // Close the dialog
                  },
                  child: const Text('OK'),
                ),
              ],
