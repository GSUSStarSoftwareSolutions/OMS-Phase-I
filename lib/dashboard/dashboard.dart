...
// Define the shake animation (values will oscillate between -5.0 and 5.0)
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            // gradient: LinearGradient(
                            //   colors: [
                            //     Color(0xFFE3F2FD).withOpacity(0.12), // Light pastel blue
                            //     Color(0xFFFFFFFF), // White
                            //   ],
                            ...
                            //     Color(0xFFE8F5E9), // Lighter Green
                            //   ],
                            //   begin: Alignment.topLeft,
                            //   end: Alignment.bottomRight,
                            // ),
                           ...
                           // color: const Color(0xFFFFFDFF),
                            ...
                            child: Row(
                              children: [
                                ...
                                //   child: Padding(
                                //     padding:
                                //         const EdgeInsets.only(top: 10, right: 80),
                                //     child: OutlinedButton(
                                //       onPressed: () {
                                //         context.go('/Create_New_Product');
                                //         // Navigator.push(
  ...
  List<Widget> _buildMenuItems(BuildContext context) {
    return [
      Container(
          ...
          child: _buildMenuItem('Home', Icons.dashboard, Colors.black, '/Home')),
      _buildMenuItem('Customer', Icons.account_circle, Colors.white, '/Customer'),
  ...
  Widget _buildMenuItem(String title, IconData icon, Color iconColor, String route) {
    ...
    title == 'Home'? iconColor = Colors.black : Colors.white;
    return
      MouseRegion(
