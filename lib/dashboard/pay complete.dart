...
void main() => runApp(PayCompleteList());

class PayCompleteList extends StatefulWidget {
  const PayCompleteList({super.key});
//  final ord.Product? product;
  @override
  State<PayCompleteList> createState() => _PayCompleteListState();
}

class _PayCompleteListState extends State<PayCompleteList> {
            ...
            child: DataTable(
                ...
                rows: List.generate(
                    math.min(itemsPerPage, filteredData1
                        .where((detail) => detail.paymentStatus == 'cleared')
          ...
          Container(
            ...
            child: DataTable(
                ...
                rows: List.generate(
                  ...
                  // final detail1 = filteredData.skip((currentPage - 1) * itemsPerPage).elementAt(index);
                  final detail = filteredData1.
                  where((detail) => detail.deliveryStatus == 'cleared').
                  skip((currentPage - 1) * itemsPerPage).elementAt(index);
