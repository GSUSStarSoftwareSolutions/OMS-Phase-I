...
void main() => runApp(OpenorderList());

class OpenorderList extends StatefulWidget {
  const OpenorderList({super.key});
//  final ord.Product? product;
  @override
  State<OpenorderList> createState() => _OpenorderListState();
}
