...
class TextStyles {
  ...
  static TextStyle login(BuildContext context) => GoogleFonts.inter(
    fontSize: responsiveFontSize(context, 0.0117), // Adjust 0.033 as needed
    fontWeight: FontWeight.w500,
    color: Colors.blue,
  );
  static TextStyle login1(BuildContext context) => GoogleFonts.inter(
    fontSize: responsiveFontSize(context, 0.018), // Adjust 0.033 as needed
    fontWeight: FontWeight.w500,
    color: Colors.blue,
  );
  static TextStyle pass(BuildContext context) => GoogleFonts.inter(
    fontSize: responsiveFontSize(context, 0.0157), // Adjust 0.033 as needed
    fontWeight: FontWeight.w500,
    color: Colors.blue,
  );
  static TextStyle loginSub(BuildContext context) => GoogleFonts.inter(
...
// Default text color
  ...
  static TextStyle email(BuildContext context) => GoogleFonts.inter(
