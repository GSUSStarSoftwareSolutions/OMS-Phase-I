  ...
  void _filterAndPaginateProducts() {
    filteredData = productList.where((product) {
      final matchesSearchText =
          product.customer.toLowerCase().contains(_searchText.toLowerCase()) ||
      ...
      if (sortDirection == 'asc') {
        filteredData.sort((a, b) {
          if (columnIndex == 0) {
            ...
            return a.telephoneNumber1
                .toLowerCase()
                .compareTo(b.telephoneNumber1.toLowerCase());
        ...
        filteredData.sort((a, b) {
          if (columnIndex == 0) {
            ...
            return b.telephoneNumber1
                .toLowerCase()
                .compareTo(a.telephoneNumber1.toLowerCase());
          } else if (columnIndex == 4) {
                    ...
                    cells: [
                      ...
                      DataCell(
                        SizedBox(
                          ...
                          child: Text(
                            detail.telephoneNumber1.toString(),
                            style: TextStyles.body,
                          ),
                        ),
                      ),
                    ...
                    onSelectChanged: (selected) {
                      if (selected != null && selected) {
                        if (filteredData.length <= 9) {
                          context.go('/Cus_Details',
                              extra: {'orderId': detail.customer});
                        } else {
                          context.go('/Cus_Details',
                              extra: {'orderId': detail.customer});
                        }
        ...
        filteredData.sort((a, b) {
          if (columnIndex == 0) {
            ...
            return a.emailAddress
                .toLowerCase()
                .compareTo(b.emailAddress.toLowerCase());
          } else {
            return 0;
          }
        });
