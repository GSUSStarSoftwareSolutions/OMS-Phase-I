...
void main() => runApp(CusPickorder());

class CusPickorder extends StatefulWidget {
  const CusPickorder({super.key});
//  final ord.Product? product;
  @override
  State<CusPickorder> createState() => _CusPickorderState();
}

class _CusPickorderState extends State<CusPickorder> {
            ...
            child: DataTable(
                ...
                rows: List.generate(
                    math.min(itemsPerPage, filteredData1
                        .where((detail) => detail.deliveryStatus == 'Picked' && detail.CusId == userId)
