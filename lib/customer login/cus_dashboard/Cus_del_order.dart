...
void main() => runApp(Cusorderdlvy());

class Cusorderdlvy extends StatefulWidget {
  const Cusorderdlvy({super.key});
//  final ord.Product? product;
  @override
  State<Cusorderdlvy> createState() => _CusorderdlvyState();
}

class _CusorderdlvyState extends State<Cusorderdlvy> {
                                                  ...
                                                  children: [
                                                    PaginationControls(
                                                      ...
                                                      product.deliveryStatus ==
                                                          'Delivered' && product.CusId == userId)
                                                          .length /
                                                          itemsPerPage).ceil(),
            ...
            child: DataTable(
                ...
                rows: List.generate(
                    math.min(itemsPerPage, filteredData1
                        .where((detail) => detail.deliveryStatus == 'Delivered' && detail.CusId == userId)
