...
class CusCreditPage extends StatefulWidget {
  const CusCreditPage({super.key});

  @override
  State<CusCreditPage> createState() => _CusCreditPageState();
}

class _CusCreditPageState extends State<CusCreditPage> {
  ...
  List<Widget> _buildMenuItems(BuildContext context) {
    return [
      ...
      _buildMenuItem('Credit Notes', Icons.credit_card_outlined, Colors.blueAccent, '/Customer_Credit_List'),
    ];
  }
