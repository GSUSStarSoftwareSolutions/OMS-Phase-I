...
class ReqReturn extends StatefulWidget {
  ...
  ReqReturn({super.key, required this.orderDetailsMap,required this.storeImage,this.imageSizeString,required this.imageSizeStrings,required this.storeImages,required this.orderDetails
  });
  @override
  State<ReqReturn> createState() {
    return _ReqReturnState();
  }
}

class _ReqReturnState extends State<ReqReturn> {
  ...
  List<Widget> _buildMenuItems(BuildContext context) {
    ...
    ),child: _buildMenuItem('Return', Icons.keyboard_return, Colors.white, '/Customer_Return_List')),
    ];
  }
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ElevatedButton(
                ...
                onPressed: () {
                  context.go('/Customer_Return_List');
                },
