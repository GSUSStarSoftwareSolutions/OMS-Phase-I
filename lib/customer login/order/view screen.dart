...
class CusViewScreen extends StatefulWidget {
  ...
  const CusViewScreen({super.key, this.product1,this.arrow,required this.product, this.item, this.body,this.status, this.paymentStatus,this.itemsList,this.orderDetails,this.InvNo});

  @override
  _CusViewScreenState createState() => _CusViewScreenState();
}

class _CusViewScreenState extends State<CusViewScreen> with SingleTickerProviderStateMixin{
  ...
  detail selectedOrder = detail(orderId: '',
      total: 0,
      deliveryStatus: '',
      status: '',
      orderDate: '',
...
// Optionally, show an error message to the user
  ...
  void initState() {
    ...
    _offsetAnimation = Tween<Offset>(
      ...
      end: const Offset(0.0,-0.4), // End in the center
